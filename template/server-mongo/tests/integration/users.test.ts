...
describe('Users Endpoints', () => {
  ...
  describe('GET /api/v1/users/stats', () => {
    it('should return aggregated user stats for an authenticated user', async () => {
    ...
    it('should reject unauthenticated requests', async () => {
      const response = await request(app).get('/api/v1/users/stats').expect(401);
  ...
  describe('GET /api/v1/users/:id', () => {
    ...
    it('should return 404 for non-existent user', async () => {
      ...
      // A well-formed but unused ObjectId → passes validation, resolves to no user → 404.
      const response = await request(app)
